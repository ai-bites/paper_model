function saveMeshAsObj(name,x,y,z,nx,ny,nz)
% SAVEMESHASOBJ Save a x,y,z mesh as a Wavefront/Alias Obj file
...
%
%     Example: saveMeshAsObj('test.obj',mesh3D(:,:,1),mesh3D(:,:,2),mesh3D(:,:,3));
